...
import { CheckCircle2, ArrowRight, ShieldCheck, Zap, Layers, Award } from 'lucide-react';
  ...
  return (
    <section className="py-20 lg:py-28 bg-[#FFFBEB] text-slate-900 border-t border-b border-amber-200/80 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {tallyEditions.map((edition) => {
            ...
            return (
              <div
                key={edition.id}
                className={`p-8 rounded-3xl border flex flex-col justify-between space-y-6 transition-all duration-300 ${
                  isPopular
        ...
        <div className="bg-white border border-amber-200/90 rounded-3xl overflow-hidden shadow-sm">
