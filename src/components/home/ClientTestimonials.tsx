...
import { Star, Quote, ShieldCheck, CheckCircle2, Building2, User } from 'lucide-react';
  ...
  return (
    <section className="py-20 lg:py-28 bg-[#FFFBEB] text-slate-900 border-t border-b border-amber-200/80 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 space-y-16">
        ...
        {/* 3 Luxurious Light Duotone Client Testimonial Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((item) => (
            <div
              key={item.id}
              className="bg-white border-2 border-amber-200/90 rounded-3xl p-8 lg:p-9 space-y-6 flex flex-col justify-between shadow-md hover:border-amber-500 hover:-translate-y-1 transition-all duration-300 group"
            >
