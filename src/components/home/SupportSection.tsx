...
import { Phone, Monitor, FileCheck, ShieldCheck, Activity, Clock, Headphones, CheckCircle2 } from 'lucide-react';
    ...
    <section className="py-24 lg:py-32 bg-[#0A0E1A] text-white border-b border-emerald-500/20 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 space-y-4">
            {pathways.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 rounded-3xl bg-slate-900/90 border border-emerald-500/30 hover:border-emerald-400 shadow-2xl transition-all flex items-start gap-4"
                >
          ...
          <div className="lg:col-span-5 bg-slate-900/95 text-white rounded-3xl p-8 border border-amber-500/30 shadow-2xl flex flex-col justify-between space-y-6">
            ...
            <div className="pt-4 border-t border-white/10 space-y-3">
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-4 text-xs font-bold text-slate-950 bg-gradient-to-r from-emerald-400 to-emerald-500 hover:from-emerald-300 hover:to-emerald-400 rounded-xl transition-all shadow-md"
              >
