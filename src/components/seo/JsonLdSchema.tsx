...
export default function JsonLdSchema() {
  const localBusinessSchema = {
    ...
    legalName: companyInfo.legalName || companyInfo.name,
    url: 'https://sbenterprise.co.in',
    logo: 'https://sbenterprise.co.in/images/luxury_workspace.jpg',
    image: 'https://sbenterprise.co.in/images/luxury_workspace.jpg',
    description:
    ...
    address: {
      '@type': 'PostalAddress',
      streetAddress: companyInfo.location.addressLine1 || companyInfo.location.fullAddress,
